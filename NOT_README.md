...
Commands:
  ...
  outline|o [options] <targetOutlineDir>  Create outline files from a directory of markdown files
...
```bash
Usage: skelo-cli outline|o [options] <targetOutlineDir>

Create outline files from a directory of markdown files

Arguments:
  targetOutlineDir                   Target directory for outline files
