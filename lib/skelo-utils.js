...
function normalizeItem(item) {
    ...
    // Convert string item to an object with a label
    ...
    // Normalize items and headings
    ['items', 'headings'].forEach(prop => {
        if (item[prop]) {
    ...
    // Validate that item does not have both items and headings
